...
# Programmer flags - going for Xmega Xplained board which uses the new flip
# protocol to program it
ISP = flip2

# if other programmer is needed the flags can be set accordingly
# like also adding a port
ISP_FLAGS =
